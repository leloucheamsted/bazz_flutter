...
import 'package:bazz_flutter/modules/home_module/views/map/flutter_map_marker_popup/src/popup_container.dart';
...
class PopupPosition {
  ...
  static PopupContainer _snapToMarkerLeft(
    ...
    return PopupContainer(
      ...
      top:
          markerPosition.y - (visibleSize.y / 2) + (markerSize.y / 2) as double,
  ...
  static PopupContainer _snapToMarkerTop(
    ...
    return PopupContainer(
      ...
      left:
          markerPosition.x - (visibleSize.x / 2) + (markerSize.x / 2) as double,
