...
import 'package:bazz_flutter/modules/home_module/views/map/flutter_map_marker_popup/src/popup_builder.dart';
import 'package:bazz_flutter/modules/home_module/views/map/flutter_map_marker_popup/src/popup_controller.dart';
import 'package:bazz_flutter/modules/home_module/views/map/flutter_map_marker_popup/src/popup_event.dart';
import 'package:bazz_flutter/modules/home_module/views/map/flutter_map_marker_popup/src/popup_event_actions.dart';
import 'package:bazz_flutter/modules/home_module/views/map/flutter_map_marker_popup/src/popup_position.dart';
import 'package:bazz_flutter/modules/home_module/views/map/flutter_map_marker_popup/src/popup_snap.dart';
...
class _MarkerPopupState extends State<MarkerPopup> {
  ...
  late UniqueKey _popupKey; // Changing forces child rebuild.
  ...
  void _hideAny() {
    if (_selectedMarker != null) {
      setState(() {
        _popupKey = null as UniqueKey;
        _selectedMarker = null as Marker;
      });
    }
  }
