...
import 'package:bazz_flutter/modules/home_module/flutter_map/src/geo/crs/crs.dart';
import 'package:bazz_flutter/modules/home_module/flutter_map/src/gestures/interactive_flag.dart';
import 'package:bazz_flutter/modules/home_module/flutter_map/src/gestures/map_events.dart';
import 'package:bazz_flutter/modules/home_module/flutter_map/src/gestures/multi_finger_gesture.dart';
...
import 'package:bazz_flutter/modules/home_module/flutter_map/src/plugins/plugin.dart';
import 'package:latlong/latlong.dart';

export 'package:bazz_flutter/modules/home_module/flutter_map/src/core/point.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/geo/crs/crs.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/geo/latlng_bounds.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/gestures/interactive_flag.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/gestures/map_events.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/gestures/multi_finger_gesture.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/circle_layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/group_layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/marker_layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/overlay_image_layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/polygon_layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/polyline_layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/tile_layer.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/layer/tile_provider/tile_provider.dart';
export 'package:bazz_flutter/modules/home_module/flutter_map/src/plugins/plugin.dart';
    ...
    if (adaptiveBoundaries!) {
      ...
      return LatLng(
        ...
        point.longitude.clamp(
            swPanBoundary!.longitude, nePanBoundary!.longitude) as double,
      );
    }
  }
...
class _SafeArea {
  ...
  bool contains(point) => isLatitudeBlocked || isLongitudeBlocked
      ? false
      : bounds.contains(point as LatLng);

  LatLng containPoint(LatLng point, LatLng fallback) => LatLng(
        isLatitudeBlocked
            ? fallback.latitude as double
            : point.latitude.clamp(bounds.south, bounds.north) as double,
        isLongitudeBlocked
            ? fallback.longitude as double
            : point.longitude.clamp(bounds.west, bounds.east) as double,
      );
}
