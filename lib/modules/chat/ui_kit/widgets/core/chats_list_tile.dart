...
import 'package:bazz_flutter/modules/chat/ui_kit/utils/date_formatter.dart';
...
class ChatsListTileBuilders<T extends ChatBase> {
  ...
  late Widget Function(BuildContext context, int imageIndex, int itemIndex,
  ...
  late ChatsWidgetBuilder? unreadBubbleBuilder;
...
class ChatsListTile<T extends ChatBase> extends StatelessWidget {
  ...
  Widget _buildLeading(BuildContext context) {
    ...
    if (!unreadBubbleEnabled || (item.unreadCount) < 1) return child;
