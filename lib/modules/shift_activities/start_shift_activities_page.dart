...
class StartShiftActivitiesPage extends GetView<ShiftActivitiesService> {
  const StartShiftActivitiesPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return KeyboardDismissOnTap(
      child: Scaffold(
        body: Column(
          children: [
            CustomAppBar(withBackButton: true, title: 'Start Shift Activities'),
