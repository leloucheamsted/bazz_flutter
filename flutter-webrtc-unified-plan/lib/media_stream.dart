...
class MediaStream {
  ...
  String _streamId;
  String _ownerTag;
  late List<MediaStreamTrack>? _audioTracks;
  late List<MediaStreamTrack>? _videoTracks;
  ...
  void setMediaTracks(List<dynamic> audioTracks, List<dynamic> videoTracks) {
    List<MediaStreamTrack>? newAudioTracks;
    ...
    List<MediaStreamTrack>? newVideoTracks;
